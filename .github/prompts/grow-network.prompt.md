...
1. Read `data/network_growth.md` and check how many requests were sent this week. Enforce the 100/week cap.
...
3. Filter to relevant profiles. Exclude anyone already in `data/network_growth.md`.
...
7. Log each sent request to `data/network_growth.md`.
