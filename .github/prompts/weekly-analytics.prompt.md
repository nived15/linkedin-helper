...
3. Read `data/content_queue.md` to summarise posts published this week and their engagement.
4. Read `data/network_growth.md` to get connection requests sent, accepted, and acceptance rate.
5. Populate the report using the `growth-report` skill's `assets/report-template.md` structure.
6. Save to `data/analytics/YYYY-MM-DD-summary.md` (readable report).
