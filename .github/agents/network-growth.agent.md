...
- **Hard cap: 100 connection requests per week.** Always check `data/network_growth.json` first.
...
1. Read `data/network_growth.json` to check weekly budget.
...
6. On confirmation, send requests (MCP tools) and log to `data/network_growth.json`.
