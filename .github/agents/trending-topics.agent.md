...
3. Save to `data/trending_queue.md` with status `staged`.
4. Ask Nived to review.

### Phase 2 — Engage

1. Read `data/trending_queue.md` for `approved` entries.
...
- `comment_on_approved_posts` — batch comment on all approved posts from trending_queue.md
